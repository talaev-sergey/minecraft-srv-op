...
class ServerTimePanel(ft.Card):
    ...
    def update_state(self, status_server: int, time_server: str):
        # self.elevated_time.visible = True if status_server == 1 else False
        self.elevated_time.text = time_server
        self.update()
